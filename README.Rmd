...
[![Travis-CI Build Status](https://travis-ci.com/ranghetti/guinterp.svg?branch=master)](https://travis-ci.com/ranghetti/guinterp)
[![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](http://www.gnu.org/licenses/gpl-3.0)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v1.4%20adopted-ff69b4.svg)](http://guinterp.ranghetti.info/.github/CODE-OF-CONDUCT.html)
...
selecting it).
In case multiple polygons are loaded, they can be threated as separate objects
during interpolation.

After loading files, the main GUI appears.
In the left column, data can visualised thanks to a histogram and a map;
both of them hightlight filtered vs. non-filtered points.
...
L.\ Ranghetti, M.\ Boschetti, D.\ Cillis, L.\ Busetto (2020). 
**"GUInterp: a Shiny GUI to support spatial interpolation"**. 
*European R users meeting (eRum)*, Milano, 17-20/06/2020. 
...
This project is released with a [Contributor Code of Conduct](http://guinterp.ranghetti.info/.github/CODE-OF-CONDUCT.html).
